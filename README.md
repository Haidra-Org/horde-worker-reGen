...
- If you are upgrading from `AI-Horde-Worker`, you will have to manually move your models folder to the `reGen` folder. This folder may be named `models` or `nataili` (depending on when you installed) and should contain a folder named `compvis`.
